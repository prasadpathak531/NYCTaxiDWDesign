IF NOT EXISTS (SELECT * FROM sys.objects O JOIN sys.schemas S ON O.schema_id = S.schema_id WHERE O.NAME = 'stagefactfhvtaxis' AND O.TYPE = 'U' AND S.NAME = 'dbo')
CREATE TABLE dbo.stagefactfhvtaxis
	(
...
--CREATE PROC bulk_load_stagefactfhvtaxis
--AS
--BEGIN
COPY INTO dbo.stagefactfhvtaxis
...
SELECT TOP 100 * FROM dbo.stagefactfhvtaxis
GO